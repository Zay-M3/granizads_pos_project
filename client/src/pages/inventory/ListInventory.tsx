...
const ListInventory = () => {
  ...
  useEffect(() => {
    const fetchInsumos = async () => {
      try {
        ...
        setErrorModal({ isOpen: true, message: "Error al cargar los insumos" });
      }
    };
    fetchInsumos();
  }, []);
  ...
  const getInsumoStatus = (
    insumo: Insumo
  ): "available" | "low-stock" | "critical" => {
  ...
  const filteredInsumos = insumos.filter((insumo) => {
    const matchesSearch = insumo.nombre
      .toLowerCase()
      .includes(searchTerm.toLowerCase());
    const insumoStatus = getInsumoStatus(insumo);
    const matchesStatus =
      selectedStatus === "all" || insumoStatus === selectedStatus;
      ...
      if (updatedInsumo.id_insumo) {
        ...
        setInsumos((prevInsumos) =>
          prevInsumos.map((insumo) =>
            insumo.id_insumo === updatedInsumo.id_insumo
              ? updatedInsumo
              : insumo
          )
        );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Gestiona el stock de insumos para tus productos
          </p>
        </div>
        <button
              ...
              <div className="p-4">
                <div className="mb-3">
                  ...
                  <p className="text-sm text-gray-500">
                    Última compra: {insumo.fecha_compra}
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Mínimo: {insumo.minimo_stock} {insumo.unidad_medida}
                  </p>
                </div>
