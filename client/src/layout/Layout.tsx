    ...
    <div className="flex h-screen bg-secondary font-sans overflow-hidden">
      ...
      <aside className="w-20 bg-primary-dark flex flex-col items-center py-6 space-y-8">
        ...
        <nav className="flex flex-col space-y-6">
          <button className="w-12 h-12 rounded-lg bg-primary hover:bg-card transition-colors flex items-center justify-center">
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
          </button>

          <button className="w-12 h-12 rounded-lg hover:bg-primary/20 transition-colors flex items-center justify-center">
        ...
        <div className="mt-auto">
          <button className="w-12 h-12 rounded-full bg-card hover:bg-button transition-colors flex items-center justify-center">
            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white shadow-sm flex items-center justify-between px-6">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-display font-bold text-primary-dark">DrinKeo POS</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 pl-4 border-l border-secondary">
              <div className="text-right">
                <p className="text-sm font-medium text-primary-dark">Juan Cajero</p>
                <p className="text-xs text-gray-500">{formatTime(currentTime)}</p>
              </div>
              <div className="w-10 h-10 bg-gradient-to-br from-primary to-card rounded-full"></div>
            </div>
          </div>
        </header>
